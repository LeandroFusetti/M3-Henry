...
function problemC () {
  ...
  /* o sino puede hacerce asi */

  promisifiedReadFile('poem-one/stanza-02.txt')
  .then(stanza2=>{
    blue(stanza2)
    return promisifiedReadFile('poem-one/stanza-03.txt')  //si lo retorn estoy obteniendo el valor de resolucion de stanza3(promisifiedReadFile('poem-one/stanza-03.txt') ), es decir stanza 3
    })
...
function problemF () {
  ...
  /* promisifiedReadFile('poem-one/stanza-03.txt')
    ...
    .finally(()=>console.log("done")) //recibe una callback
}
